...
fn fold(character: char) -> char {
    ...
    // keeps a line in the skin's own font instead of question marks.
...
mod tests {
    ...
    fn a_title_punctuated_full_width_keeps_the_skin_font() {
        // One uncovered character would draw as question marks, so a title
        // written this way used to lose the skin's font outright.
        assert!(
